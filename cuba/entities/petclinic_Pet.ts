...
export type PetViewName = "_minimal" | "_local" | "_base" | "pet-with-owner-and-type";
export type PetView<V extends PetViewName> = V extends "_minimal" ? Pick<Pet, "id" | "identificationNumber" | "name"> : V extends "_local" ? Pick<Pet, "id" | "identificationNumber" | "birthDate" | "name"> : V extends "_base" ? Pick<Pet, "id" | "identificationNumber" | "name" | "birthDate"> : V extends "pet-with-owner-and-type" ? Pick<Pet, "id" | "identificationNumber" | "birthDate" | "name" | "type" | "owner"> : never;
